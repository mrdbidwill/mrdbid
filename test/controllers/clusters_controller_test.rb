...
class ClustersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cluster" do
    assert_difference("Cluster.count") do
      post clusters_url, params: { cluster: { comments: @cluster.comments, description: @cluster.description, entered_by_id: @cluster.entered_by_id, name: @cluster.name, source_id: @cluster.source_id } }
    end
  ...
  test "should update cluster" do
    patch cluster_url(@cluster), params: { cluster: { comments: @cluster.comments, description: @cluster.description, entered_by_id: @cluster.entered_by_id, name: @cluster.name, source_id: @cluster.source_id } }
