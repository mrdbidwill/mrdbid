...
class MrCharactersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mr_character" do
    assert_difference("MrCharacter.count") do
      post mr_characters_url, params: { mr_character: { display_options_id: @mr_character.display_options_id, entered_by_id: @mr_character.entered_by_id, lookup: @mr_character.lookup, name: @mr_character.name, parts_id: @mr_character.parts_id, source_id: @mr_character.source_id } }
    end
  ...
  test "should update mr_character" do
    patch mr_character_url(@mr_character), params: { mr_character: { display_options_id: @mr_character.display_options_id, entered_by_id: @mr_character.entered_by_id, lookup: @mr_character.lookup, name: @mr_character.name, parts_id: @mr_character.parts_id, source_id: @mr_character.source_id } }
