...
class MrCharactersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create mr_character' do
    assert_difference('MrCharacter.count') do
      post mr_characters_url,
           params: { mr_character: { display_option_id: @mr_character.display_option_id, name: @mr_character.name,
                                     part_id: @mr_character.part_id, source_data_id: @mr_character.source_data_id } }
    end
  ...
  test 'should update mr_character' do
    patch mr_character_url(@mr_character),
          params: { mr_character: { display_option_id: @mr_character.display_option_id, name: @mr_character.name,
                                    part_id: @mr_character.part_id, source_data_id: @mr_character.source_data_id } }
