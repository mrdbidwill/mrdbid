...
class CameraModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camera_model" do
    assert_difference("CameraModel.count") do
      post camera_models_url, params: { camera_model: { camera_make_id: @camera_model.camera_make_id, comments: @camera_model.comments, description: @camera_model.description, name: @camera_model.name } }
    end
  ...
  test "should update camera_model" do
    patch camera_model_url(@camera_model), params: { camera_model: { camera_make_id: @camera_model.camera_make_id, comments: @camera_model.comments, description: @camera_model.description, name: @camera_model.name } }
