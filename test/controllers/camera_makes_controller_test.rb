...
class CameraMakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camera_make" do
    assert_difference("CameraMake.count") do
      post camera_makes_url, params: { camera_make: { comments: @camera_make.comments, description: @camera_make.description, name: @camera_make.name } }
    end
  ...
  test "should update camera_make" do
    patch camera_make_url(@camera_make), params: { camera_make: { comments: @camera_make.comments, description: @camera_make.description, name: @camera_make.name } }
