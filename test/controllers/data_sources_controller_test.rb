...
class DataSourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_source" do
    assert_difference("DataSource.count") do
      post data_sources_url, params: { data_source: { comments: @data_source.comments, description: @data_source.description, entered_by_id: @data_source.entered_by_id, name: @data_source.name, source_id: @data_source.source_id } }
    end
  ...
  test "should update data_source" do
    patch data_source_url(@data_source), params: { data_source: { comments: @data_source.comments, description: @data_source.description, entered_by_id: @data_source.entered_by_id, name: @data_source.name, source_id: @data_source.source_id } }
