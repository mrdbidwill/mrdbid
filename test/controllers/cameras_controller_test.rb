...
class CamerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camera" do
    assert_difference("Camera.count") do
      post cameras_url, params: { camera: { camera_make_id: @camera.camera_make_id, camera_model: @camera.camera_model, entered_by_id: @camera.entered_by_id } }
    end
  ...
  test "should update camera" do
    patch camera_url(@camera), params: { camera: { camera_make_id: @camera.camera_make_id, camera_model: @camera.camera_model, entered_by_id: @camera.entered_by_id } }
