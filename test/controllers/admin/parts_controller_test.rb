...
class PartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create part" do
    assert_difference("Part.count") do
      post parts_url, params: { part: { comments: @part.comments, description: @part.description, name: @part.name } }
    end
  ...
  test "should update part" do
    patch part_url(@part), params: { part: { comments: @part.comments, description: @part.description, name: @part.name } }
