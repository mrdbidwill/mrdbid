...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference("Permission.count") do
      post permissions_url, params: { permission: { comments: @permission.comments, description: @permission.description, name: @permission.name } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { comments: @permission.comments, description: @permission.description, name: @permission.name } }
