...
class RolePolicyTest < ActiveSupport::TestCase
  ...
  test "should not authorize regular user to view index" do
    assert_not Pundit.policy(@regular_user, Role).index?
  end

  test "should not authorize nil user to view index" do
    assert_not Pundit.policy(nil, Role).index?
  end
  ...
  test "should not authorize regular user to show" do
    assert_not Pundit.policy(@regular_user, @role).show?
  end

  test "should authorize admin to new" do
    assert Pundit.policy(@admin_user, Role.new).new?
  end

  test "should not authorize regular user to new" do
    assert_not Pundit.policy(@regular_user, Role.new).new?
  end

  test "should authorize admin to create" do
    assert Pundit.policy(@admin_user, Role.new).create?
  end

  test "should not authorize regular user to create" do
    assert_not Pundit.policy(@regular_user, Role.new).create?
  end
  ...
  test "should not authorize regular user to edit" do
    assert_not Pundit.policy(@regular_user, @role).edit?
  end
  ...
  test "should not authorize regular user to update" do
    assert_not Pundit.policy(@regular_user, @role).update?
  end
  ...
  test "should not authorize regular user to destroy" do
    assert_not Pundit.policy(@regular_user, @role).destroy?
  end
end
