<p>The goal of MRDBID.com is to provide personal storage of specimens including many possible characters.</p>

<p>In order to do so, the set of characters must be public and inclusive of every character that could be used in a specimen. A list of characters that are currently supported by MRDBID.com will be accessible to all for review.</p>
