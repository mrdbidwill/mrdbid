                    ...
                    <div class="mt-8 flow-root">
                        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                ...
                                <x-display_existing_specimen_characters :characters="$characters"
                                                                        :characterIds="$characterIds"
                                                                        :specimenID="$specimenId"></x-display_existing_specimen_characters>
                                ...
                                <table class="min-w-full divide-y divide-gray-700">
                                    ...
                                    <x-edit_characters_switch :characters="$characters"
                                                              :character_ids="$characterIds"></x-edit_characters_switch>
                                    </tbody>
