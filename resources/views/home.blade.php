<x-layout>
    <main class="mt-6 space-y-4">
        ...
        <p>There you
            go. A beginning. Any clear photo with <b class="text-orange-700">measurements</b> is a plus. <u>If
                a
        ...
        <div class="bg-gray-200 p-4">
            ...
            <p class="text-sm">Richard W. Kerrigan's <i><b>AGARICUS</b> of NORTH AMERICA</i>, middle of
                ...
                22, "To estimate the
                size of
                specimens in the field, or to preserve scale information in photographs, it is useful to
                know
                the
        ...
        <p>The most useful pictures will clearly document mushroom characters and <b
                class="text-orange-700">measurements</b>,
            along
        ...
        <p>After completing the form <u>in the field</u>, take a picture of it with your specimen. Notice
            the <b
        ...
        <p>You will get better with practice. Yes, a microscope helps and is not that difficult to learn to
            use,
