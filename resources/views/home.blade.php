<x-layout>
    <main class="mt-6 space-y-4">
        ...
        <p class="mt-2 text-xl text-black">There you
            go. A beginning. Any clear photo with <b class="text-orange-700">measurements</b> is a plus. <u>Use coins if
                a ruler is not handy</u>.</p>
        ...
        <p class="mt-2 text-xl text-black">This is not a "key" identification process, like <a
                href="https://www.mushroomexpert.com">https://www.mushroomexpert.com</a>.
