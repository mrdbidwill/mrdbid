...
<div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    ...
    <div
        ...
        </div>  <!-- moved from above down to  put logo same level as links -->
        <main class="mt-6">
            <div class="bg-white overflow-hidden sm:rounded-lg">
                <div class="p-6 text-gray-900">

                    <p>This website is a tool for storing and organizing <u>data</u> for mushrooms that you
                        ...
                        database, you can edit it as needed and add more character details as you discover them.</p>

                    <p>The fact you observed a mushroom means you have some visual, time and location data. That is
