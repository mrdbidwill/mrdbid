<x-layout>
    ...
    <p>Register or login, then go to <b>Specimens</b> to get started. The process will take it from there, hopefully. <u>The link to Dashboard will NOT appear until you register and log in.</u></p>
    ...
    <p>Use this form. You can get it at link above: <img src="{{ Vite::asset('resources/images/AMS_Field_Data_Sheet_400x298.png') }}" alt="AMS Field Data Sheet"></p>

    <p>After completing the form <u>in the field</u>, take a picture of it. Then, once home and when you get around to it, add the data and the pictures you took of the specimen, including this form, to your specimen list. You then have it to refer to online wherever you are, and update as needed while you identify your specimen.</p>
