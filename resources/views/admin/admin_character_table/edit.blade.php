<x-layout>
    ...
    <form method="POST"
          action="/admin_character_table/{{ $character_table[0]['id'] }} ">
        @csrf
        @method('PATCH')
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        <label for="display_options"
                               class="block text-sm font-medium leading-6 text-gray-900">Display Option</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input
                                    ...
                                    id="display_options"
                                    class="block flex-1 border-0 bg-transparent py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    value="{{ $character_table[0]['display_options'] }}" - {{$display_options->name}}
                                    required>
                            </div>
                    ...
                    <div class="sm:col-span-4">
                        <label for="look_up_y_n"
                               class="block text-sm font-medium leading-6 text-gray-900">Is Lookup Table?</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input
                    ...
                    <div class="sm:col-span-4">
                        <label for="parts"
                               class="block text-sm font-medium leading-6 text-gray-900">What part of mushroom?</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input
