            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <x-form-field>
                        ...
                        <fieldset>
                            <label>Yes<input type="radio" name="look_up_y_n" value="0"></label>
                            <label>No<input type="radio" name="look_up_y_n" value="1"></label>
                        </fieldset>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            @foreach($parts as $part)
                                <input type="radio" value="{{ $part->id }}" id="parts"
