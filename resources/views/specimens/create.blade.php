        ...
        <table
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    <label for="specimen_name" class="block text-sm font-medium leading-6 text-black">Specimen
                        Name</label> <input class="consistent-width" type="text" name="specimen_name" id="specimen_name"
                                            placeholder="You pick the name, such as abc_12_31_99_agaricus_maybe..."
                                            value="" required>
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    ...
                    <label for="common_name" class="block text-sm font-medium leading-6 text-gray-900">Common
                        Name</label> <input class="consistent-width" type="text" name="common_name" id="common_name"
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    <label for="description"
                           class="block text-sm font-medium leading-6 text-gray-900">Description</label> <input
                        class="consistent-width" type="text" name="description" id="description"
                                    ...
                                    <div class="radio-wrapper">
                                        @if( $item->id == 1)
                                            ...
                                            <input class="radio-button" type="radio" id="specimen_location_now"
                                                   name="specimen_location_now" value="{{$item->id}}" required checked>
                                        @else
                                            <input class="radio-button" type="radio" id="specimen_location_now"
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    ...
                    <x-display-state-country-dropdown id="country_id" :countries="$countries"/>
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    <label for="location_found_city" class="block text-sm font-medium leading-6 text-gray-900">Nearest
                        city or town</label> <input class="consistent-width" type="text" name="location_found_city"
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    ...
                    <label for="location_found_county"
                           class="block text-sm font-medium leading-6 text-gray-900">County</label> <input
                        class="consistent-width" type="text" name="location_found_county" id="location_found_county"
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    ...
                    <label for="location_public_y_n" class="block text-sm font-medium leading-6 text-gray-900">Make
                        location visible to others?</label> <input type="radio" id="location_public_y_n"
                                                                   name="location_public_y_n" value="1" required
                                                                   checked> <label for="location_public_y_n">Yes</label>

                    <input type="radio" id="location_public_y_n" name="location_public_y_n" value="0" required> <label
                        for="location_public_y_n">No</label>
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    ...
                    <label for="share_data_y_n" class="block text-sm font-medium leading-6 text-gray-900">Share this
                        data with others?</label> <input type="radio" id="share_data_y_n" name="share_data_y_n"
                                                         value="1" required checked> <label
                        for="share_data_y_n">Yes</label>
                                ...
                                <td class="radio-cell">
                                    <div class="radio-wrapper">
                                        <input class="radio-button" type="radio" id="{{ $month[0] }}" name="month_found"
                                               value="{{ $month[0] }}" required @if($loop->first) checked @endif> <label
                                            for="month_{{ $month[0] }}" class="radio-label">{{ $month[1] }}</label>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
            ...
            <tr>
                <td style="padding: 0.5rem; border: 4px solid #93c5fd;">
                    ...
                    <label for="year_found" class="block text-sm font-medium leading-6 text-gray-900">Year Found (todo:
                        year range 1900 to 2024?)</label>
                            ...
                            <tr>
                                <td class="radio-cell">
                                    <div class="radio-wrapper">
                                        ...
                                        @else
                                            <input type="radio" class="consistent-width" id="fungus_type"
                                                   name="fungus_type" value="{{$item->id}}" required>
                                        @endif
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $country.on('change', function () {
                ...
                $state.empty(); // Clear previous options
                $state.append('<option value="" disabled selected>Select your state</option>'); // Reset dropdown

                if (countryId) {
                    $.ajax({
                        url: '/get-states/' + countryId, // Adjust the URL if necessary
                        type: "GET",
                        dataType: "json",
