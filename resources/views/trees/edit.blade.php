                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input
                                    type="number"
                                    name="tree_location_now"
                                    id="tree_location_now"
                                    class="block flex-1 border-0 bg-transparent py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    value="{{ $tree['tree_location_now'] }}"
                                    required>
                            </div>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input
                                    ...
                                    value="{{ $tree['location_found_city'] }}"
                                    required>
                            </div>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input
                                    ...
                                    value="{{ $tree['location_found_county'] }}"
                                    required>
                            </div>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input
                                    ...
                                    class="block flex-1 border-0 bg-transparent py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    value="{{ $tree['location_public_y_n'] }}"
                                    required>
                            </div>
