@foreach ($characters as $character)
    <tr>
        <td>
            ...
            @php
                //dd($mr_characters);    // list of ALL mr_characters in mr_characters table
                //dd($characterSpecimens);  // list of EXISTING mr_characters in mr_character_specimens table
            ...
            @switch($character['display_options'])
                ...
                @case(2)
                    ...
                    <!--  <p>{{$display_character_name}}: text box number mm - line 18 component
                        edit-mr_characters-switch.blade.php</p>  -->
                ...
                @case(6)
                    <!--  color  ALL color mr_characters use the colors table-->
                ...
                @case(7)
                    <!--  taste ALL taste mr_characters use the tastes table-->
                ...
                @case(8)
                    <!-- odor ALL odor mr_characters use the odors table-->
