    ...
    <tr>
        <td>
            ...
            @php
                ...
                //dd($characterIds);  // list of EXISTING characters in character_specimens table
            ...
            @switch($character['display_options'])
                ...
                @case(2)
                    ...
                    <!--  <p>{{$character_name}}: text box number mm - line 18 component
                        edit_characters_switch.blade.php</p>  -->
                ...
                @case(3)
                    ...
                    <p>{{$character_name}}: text box number um - line 37</p>
                ...
                @case(9)
                    ...
                    @if( $characterIds->contains($character['id']) )
                        ...
                        <p>Character ID: {{$character['id']}}
                            <b>{{$character['name']}}</b> is in the array</p>
                        <hr>
                    @else
                        <!--
                                                            <hr>
