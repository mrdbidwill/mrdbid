@php
    ...
    echo "Specimen ID: ".e($specimenID)."  <!-- from display-existing-basic-specimen-mr_characters.blade.php -->";
@endphp
...
@foreach ($specimens as $specimen)
    ...
    <div class="border-2 border-amber-400 bg-amber-200 m-auto p-2">
        <!-- begin from display-existing-basic-specimen-mr_characters.blade.php -->
        ...
        @else
            <div class="text-sm">Source: <i>{{$source->title}}</i> {{$source->author}}</div>
        @endif
    </div>         <!-- end from display-existing-basic-specimen-mr_characters.blade.php -->
