...
<nav class="bg-gray-100 p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-4">
            ...
            <x-specimens-nav-link href="{{ route('mr_character_specimens.index') }}"
                                  :active="request()->routeIs('mr_character_specimens.index')">
                Characters
            </x-specimens-nav-link>
            ...
            <x-specimens-nav-link href="{{ route('all_groups.index') }}"
                                  :active="request()->routeIs('all_groups.index')">
                Manage Groups
            </x-specimens-nav-link>
        </div>
