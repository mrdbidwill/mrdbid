@php
    ...
    use Illuminate\Http\Request;
       ...
       $specimen_id = request()->input('specimen_id');
        ...
        $characterSpecimen = new MrCharacterSpecimen();
         ...
         * sorting by mr_characters table name alphabetically
         "id" => 12
        "character_id" => 99
        "specimen_id" => 2
        ...
        */
        ...
        // Fetch all mr_characters whose IDs are present in $set_characters
        $character_ids = $set_characters->pluck('character_id')->all();
        $characters = Character::whereIn('id', $character_ids)->get()->keyBy('id');

        // Sort the set_characters by the name of mr_characters
