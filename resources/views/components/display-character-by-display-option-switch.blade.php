@php
    use App\Models\MrCharacterSpecimen;use App\Models\Lookup\Character;use App\Utils\StringUtils;
@endphp
        ...
        @if( $character->display_options != 6 )
            <tr>
                <td class="border border-collapse border-gray-400 p-4">
                    <form method="POST" action="{{ route('mr_character_specimens.store') }}">
                        @csrf
        @endif
                        ...
                        <div id="character_{{ $character->id  }}">  <!-- div for tag  -->
                            ...
                            @foreach($data as $item)
                                ...
                                @php
                                    //dd($data);  // all data
                                    //dd($item);    // one item
                                       $select = MrCharacterSpecimen::where('character_id', $character->id )->first();
