...
@section('content')
    ...
    <x-specimens-nav-bar></x-specimens-nav-bar>
        ...
        <p class="text-gray-500 mt-4">File Address: /resources/views/all_groups/create.blade.php</p>
    @endif

    <form method="POST" action="{{ route('all_groups.store') }}">
        @csrf
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <x-cancel-button :cancelUrl="route('all_groups.index')"></x-cancel-button>
