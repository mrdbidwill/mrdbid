...
RSpec.describe "dna_sequences/new", type: :view do
  before(:each) do
    assign(:dna_sequence, DnaSequence.new(
  ...
  it "renders new dna_sequence form" do
    render

    assert_select "form[action=?][method=?]", dna_sequences_path, "post" do
