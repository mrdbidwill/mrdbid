...
RSpec.describe "image_mushrooms/edit", type: :view do
  let(:image_mushroom) {
  ...
  before(:each) do
    assign(:image_mushroom, image_mushroom)
  end

  it "renders the edit image_mushroom form" do
    render

    assert_select "form[action=?][method=?]", image_mushroom_path(image_mushroom), "post" do
