# Load the Rails environment so the scripts can access ActiveRecord and other Rails components
...
models = {
  ...
  "PileusMarginType" => "name:string description:text comments:text source:references",
