class SourcesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sources_path, status: :see_other, notice: "Source was successfully destroyed." }
  ...
  private
    ...
    def source_params
      params.expect(source: [ :title, :author, :ref, :item_code, :comment, :my_rating, :my_comment ])
    end
end
