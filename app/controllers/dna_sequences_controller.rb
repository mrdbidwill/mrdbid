class DnaSequencesController < ApplicationController
  ...
  private
    ...
    def dna_sequence_params
      params.expect(dna_sequence: [ :mushroom_id, :notes, :dna_barcode_its, :genbank_number_url, :genbank_accession_number, :herbarium_catalog_number, :mycomap_blast_results, :provisional_species_name, :sequencing_technology, :trace_files_raw_dna_data, :voucher_number ])
    end
end
