class ImageMushroomsController < ApplicationController
  ...
  private
    ...
    def image_mushroom_params
      params.expect(image_mushroom: [ :mushroom_id_id, :parts_id, :image_name, :image_file_address, :image_width, :image_height, :camera_make_id, :camera_model, :lens, :exposure, :aperture, :iso ])
    end
end
