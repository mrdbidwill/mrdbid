...
INSERT INTO `specimens` (`id`, `member_id`, `specimen_name`, `common_name`, `description`, `comment`, `specimen_location_now`, `location_found_city`, `location_found_county`, `state`, `country`, `location_public_y_n`, `month_found`, `day_found`, `year_found`, `fungus_type`, `entered_by`, `created_at`, 'updated_at') VALUES
...
INSERT INTO `specimen_location_nows` (`id`, `name`, `description`, `comments`, `source`, `entered_by`, `created_at`, 'updated_at') VALUES
