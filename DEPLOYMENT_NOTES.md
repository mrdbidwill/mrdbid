...
# sudo systemctl daemon-reload
# sudo systemctl enable puma-mrdbid.service
#
# MANAGEMENT COMMANDS:
# - Start:   sudo systemctl start puma-mrdbid.service
# - Stop:    sudo systemctl stop puma-mrdbid.service
# - Restart: sudo systemctl restart puma-mrdbid.service
# - Status:  sudo systemctl status puma-mrdbid.service
# - Logs:    sudo journalctl -xeu puma-mrdbid.service
#
# AUTOMATIC DEPLOYMENT:
# Capistrano automatically restarts Puma after deployment via:
...
#
# ⚠️  CRITICAL: Changes to this file require:
# 1. Copy to /etc/systemd/system/puma-mrdbid.service
# 2. sudo systemctl daemon-reload
# 3. sudo systemctl restart puma-mrdbid.service
# ============================================================================
...
#
# ⚠️  MISSING ENVIRONMENT VARIABLES:
# The following are loaded from /opt/mrdbid/shared/.env via Capistrano:
# - MYSQL_DATABASE, MYSQL_USER, MYSQL_PASSWORD: Database credentials
# - APP_HOST: Used for mailer URLs (mrdbid.com)
# - RAILS_MASTER_KEY: Decrypts credentials.yml.enc
# - SOLID_QUEUE_IN_PUMA: Optional - enables Solid Queue in Puma process
#
# TO ADD ENVIRONMENT VARIABLES:
# 1. Edit: /opt/mrdbid/shared/.env (NOT this file)
# 2. Format: KEY=value (one per line, no export statement)
# 3. Restart: sudo systemctl restart puma-mrdbid.service
#
...
# ExecStop: Graceful shutdown (SIGTERM) - allows cleanup before exit
#
# ⚠️  IMPORTANT: Puma configuration is in /opt/mrdbid/current/config/puma.rb
# Do NOT add puma CLI flags here - all config should be in puma.rb
# ============================================================================
ExecStartPre=/bin/rm -f /opt/mrdbid/shared/tmp/sockets/puma.sock
ExecStartPre=/bin/rm -f /opt/mrdbid/shared/tmp/pids/puma.pid
ExecStartPre=/bin/rm -f /opt/mrdbid/shared/tmp/pids/puma.state
...
#
# VIEW LOGS:
# - Systemd: sudo journalctl -xeu puma-mrdbid.service
# - Stdout:  tail -f /opt/mrdbid/shared/log/puma_stdout.log
# - Stderr:  tail -f /opt/mrdbid/shared/log/puma_stderr.log
# - Rails:   tail -f /opt/mrdbid/shared/log/production.log (NOT managed here)
# ============================================================================
