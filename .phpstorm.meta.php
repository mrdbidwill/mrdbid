...
namespace PHPSTORM_META {
    ...
    override(\config(), map([
        ...
        'filesystems.links./var/www/public_html/mrdbid/public/storage' => 'string',
    ...
    registerArgumentsSet('configs',
        ...
        'filesystems.disks.s3.endpoint', 'filesystems.disks.s3.use_path_style_endpoint', 'filesystems.disks.s3.throw', 'filesystems.disks.s3.report', 'filesystems.links./var/www/public_html/mrdbid/public/storage',
        ...
        'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher', 'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher', 'broadcasting.default', 'broadcasting.connections.reverb.driver', 'broadcasting.connections.reverb.key',
    ...
    registerArgumentsSet('routes',
        ...
        'two-factor.confirm', 'two-factor.disable', 'two-factor.qr-code', 'two-factor.secret-key', 'two-factor.recovery-codes', 'profile.show', 'sanctum.csrf-cookie', 'telescope', 'livewire.update',
        'livewire.upload-file', 'livewire.preview-file', 'home',
        'contact', 'about', 'books.showFilteredBooks', 'specimens.guest.index', 'profile.edit',
        'profile.update', 'profile.destroy', 'specimens.index', 'specimens.create', 'specimens.store',
        'specimens.show', 'specimens.edit', 'specimens.update', 'specimens.destroy', 'specimens.addToGroup',
        'specimens.addToCluster', 'mr_characters.index', 'mr_characters.create', 'mr_characters.store', 'mr_characters.show',
        'mr_characters.edit', 'mr_characters.update', 'mr_characters.destroy', 'mr_character_specimens.index', 'mr_character_specimens.create',
        'mr_character_specimens.store', 'mr_character_specimens.show', 'mr_character_specimens.edit', 'mr_character_specimens.update', 'mr_character_specimens.destroy',
        'support-articles.show', 'specimens.updateField', 'specimens.dateFoundHandler', 'getStates', 'articles.index',
        'articles.create', 'articles.store', 'articles.show', 'articles.edit', 'articles.update',
        'articles.destroy', 'trees.index', 'trees.create', 'trees.store', 'trees.show',
        'trees.edit', 'trees.update', 'trees.destroy', 'clusters.index',
        'clusters.create', 'clusters.store', 'clusters.show', 'clusters.edit', 'clusters.update',
        'clusters.destroy', 'data_sources.index', 'data_sources.create', 'data_sources.store', 'data_sources.show',
        'data_sources.edit', 'data_sources.update', 'data_sources.destroy', 'data_source_data_types.index', 'data_source_data_types.create',
        'data_source_data_types.store', 'data_source_data_types.show', 'data_source_data_types.edit', 'data_source_data_types.update', 'data_source_data_types.destroy',
        'display_options.index', 'display_options.create', 'display_options.store', 'display_options.show', 'display_options.edit',
        'display_options.update', 'display_options.destroy', 'dna_sequences.index', 'dna_sequences.create', 'dna_sequences.store',
        'dna_sequences.show', 'dna_sequences.edit', 'dna_sequences.update', 'dna_sequences.destroy', 'image_specimens.index',
        'image_specimens.create', 'image_specimens.store', 'image_specimens.show', 'image_specimens.edit', 'image_specimens.update',
        'image_specimens.destroy', 'member_list_clusters.index', 'member_list_clusters.create', 'member_list_clusters.store', 'member_list_clusters.show',
        'member_list_clusters.edit', 'member_list_clusters.update', 'member_list_clusters.destroy', 'all_groups.index', 'all_groups.create',
        'all_groups.store', 'all_groups.show', 'all_groups.edit', 'all_groups.update', 'all_groups.destroy',
        'member_types.index', 'member_types.create', 'member_types.store', 'member_types.show', 'member_types.edit',
        'member_types.update', 'member_types.destroy', 'plant_associations.index', 'plant_associations.create', 'plant_associations.store',
        'plant_associations.show', 'plant_associations.edit', 'plant_associations.update', 'plant_associations.destroy', 'plants.index',
        'plants.create', 'plants.store', 'plants.show', 'plants.edit', 'plants.update',
        'plants.destroy', 'possible_matches.index', 'possible_matches.create', 'possible_matches.store', 'possible_matches.show',
        'possible_matches.edit', 'possible_matches.update', 'possible_matches.destroy', 'project_belongs_tos.index', 'project_belongs_tos.create',
        'project_belongs_tos.store', 'project_belongs_tos.show', 'project_belongs_tos.edit', 'project_belongs_tos.update', 'project_belongs_tos.destroy',
        'specimen_compares.index', 'specimen_compares.create', 'specimen_compares.store', 'specimen_compares.show', 'specimen_compares.edit',
        'specimen_compares.update', 'specimen_compares.destroy', 'synonym.index', 'synonym.create', 'synonym.store',
        'synonym.show', 'synonym.edit', 'synonym.update', 'synonym.destroy', 'admin.dashboard',
        'admin.specimens.index', 'admin.specimens.create', 'admin.specimens.store', 'admin.specimens.show', 'admin.specimens.edit',
        'admin.specimens.update', 'admin.specimens.destroy', 'admin.export_databases.export', 'lookups.fetch', 'lookups.countries',
        'lookups.states', 'storage.local', );
    registerArgumentsSet('views',
        'about', 'admin.admin_mr_character.create', 'admin.admin_mr_character.edit', 'admin.admin_mr_character.index', 'admin.admin_mr_character.show',
        'admin.admin_data_source.create', 'admin.admin_data_source.edit', 'admin.admin_data_source.index', 'admin.admin_data_source.show', 'admin.admin_export_database.index',
        'admin.admin_lookup.create', 'admin.admin_lookup.edit', 'admin.admin_lookup.index', 'admin.admin_lookup.show', 'admin.admin_specimen.create',
        'admin.admin_specimen.edit', 'admin.admin_specimen.index', 'admin.admin_specimen.show', 'admin.dashboard', 'admin.mblist.create',
        'admin.mblist.edit', 'admin.mblist.index', 'admin.mblist.show', 'admin.mblist.upload', 'all_groups.create',
        'all_groups.edit', 'all_groups.index', 'all_groups.show', 'api.api-token-manager', 'api.index',
        'articles.create', 'articles.edit', 'articles.index', 'articles.show', 'auth.confirm-password',
        'auth.forgot-password', 'auth.login', 'auth.register', 'auth.reset-password', 'auth.two-factor-challenge',
        'auth.verify-email', 'book', 'clusters.create', 'clusters.edit', 'clusters.index',
        'clusters.index_OLD', 'clusters.show', 'compares.index', 'compares.result', 'components.action-buttons',
        'components.action-message', 'components.action-section', 'components.admin-dashboard-nav-bar', 'components.alert', 'components.application-logo',
        ...
        'components.cancel-button', 'components.checkbox', 'components.confirmation-modal', 'components.confirms-password', 'components.danger-button',
        'components.dialog-modal', 'components.display-character-by-display-option-switch', 'components.display-character-specimens-form', 'components.display-characters-lookup-table-list', 'components.display-color-character-select-table',
        'components.display-colors-top-characters-bottom-form-table', 'components.display-existing-basic-specimen-characters', 'components.display-existing-specimen-characters', 'components.display-state-country-dropdown', 'components.display-state-country-dropdown-edit',
        'components.display-unset-characters', 'components.dropdown', 'components.dropdown-link', 'components.edit_characters_switch', 'components.form-button',
        'components.form-button-small', 'components.form-error', 'components.form-field', 'components.form-input', 'components.form-label',
        'components.form-section', 'components.get-character-specimen-value-from-lookup', 'components.input', 'components.input-error', 'components.label',
        'components.modal', 'components.mrdbid-logo-svg', 'components.nav-link', 'components.notification', 'components.primary-button',
        'components.responsive-nav-link', 'components.secondary-button', 'components.section-border', 'components.section-title', 'components.site-nav-bar-one-line-no-logo',
        'components.site-nav-bar-simple-no-logo', 'components.specimens-nav-bar', 'components.specimens-nav-link', 'components.switchable-team', 'components.validation-errors',
        'components.welcome', 'contact', 'dashboardDELETE', 'data_sources.create', 'data_sources.edit',
        'data_sources.index', 'data_sources.show', 'emails.contact', 'emails.specimen-created', 'home',
        'image_specimens.create', 'image_specimens.edit', 'image_specimens.index', 'image_specimens.show', 'layouts.app',
        'layouts.guest', 'livewire.mr_character.color-selection', 'livewire.mr_character.display-colors-top-mr_characters-bottom-table', 'livewire.mr_character.display-mr_character-by-display-option-switch', 'livewire.mr_character.edit-unset-mr-characters',
        'livewire.mr_character.manage-existing-mr-characters', 'livewire.responsive-navigation', 'livewire::bootstrap', 'livewire::simple-bootstrap', 'livewire::simple-tailwind',
        'livewire::tailwind', 'mr_character_specimens.create', 'mr_character_specimens.edit', 'mr_character_specimens.index', 'mr_character_specimens.show',
        'mr_characters.OLD_index', 'mr_characters.create', 'mr_characters.edit', 'mr_characters.index', 'mr_characters.show',
        'navigation-menu', 'pdf.all_specimens', 'pdf.user_specimens', 'policy', 'profile.delete-user-form',
        ...
        'specimen_compares.create', 'specimen_compares.edit', 'specimen_compares.index', 'specimen_compares.show', 'specimens.create',
        'specimens.edit', 'specimens.filter_search', 'specimens.index', 'specimens.look_up_tables.abundance', 'specimens.look_up_tables.annulus_position',
        'specimens.look_up_tables.bulb_type', 'specimens.look_up_tables.cap_context_flesh_texture', 'specimens.look_up_tables.cap_margin_shape', 'specimens.look_up_tables.cap_margin_type', 'specimens.look_up_tables.cap_shape',
        'specimens.look_up_tables.cap_shape_top_view', 'specimens.look_up_tables.cap_surface_dryness', 'specimens.look_up_tables.cap_surface_texture', 'specimens.look_up_tables.chem_reaction', 'specimens.look_up_tables.colors',
        'specimens.look_up_tables.country', 'specimens.look_up_tables.data_source_data_type', 'specimens.look_up_tables.display_option', 'specimens.look_up_tables.dna_sequence', 'specimens.look_up_tables.epithet',
        'specimens.look_up_tables.fungus_type', 'specimens.look_up_tables.genus', 'specimens.look_up_tables.gill_attachment', 'specimens.look_up_tables.gill_breadth', 'specimens.look_up_tables.gill_context_flesh_latex_abundance',
        'specimens.look_up_tables.gill_edge', 'specimens.look_up_tables.gill_other', 'specimens.look_up_tables.gill_spacing', 'specimens.look_up_tables.gill_thickness', 'specimens.look_up_tables.habit',
        'specimens.look_up_tables.habitat', 'specimens.look_up_tables.lens', 'specimens.look_up_tables.member_type', 'specimens.look_up_tables.odor', 'specimens.look_up_tables.part',
        'specimens.look_up_tables.part_in_veil_ann_ri_posit', 'specimens.look_up_tables.partial_inner_veil_appearance', 'specimens.look_up_tables.partial_inner_veil_fate', 'specimens.look_up_tables.partial_inner_veil_texture', 'specimens.look_up_tables.plant',
        'specimens.look_up_tables.plant_association', 'specimens.look_up_tables.possible_match', 'specimens.look_up_tables.preservation_method', 'specimens.look_up_tables.project_belong_to', 'specimens.look_up_tables.soil_type',
        'specimens.look_up_tables.species', 'specimens.look_up_tables.specimen_age', 'specimens.look_up_tables.specimen_cluster', 'specimens.look_up_tables.specimen_group', 'specimens.look_up_tables.specimen_location_now',
        'specimens.look_up_tables.state', 'specimens.look_up_tables.stem_interior', 'specimens.look_up_tables.stem_location', 'specimens.look_up_tables.stem_shape', 'specimens.look_up_tables.stem_surface',
        'specimens.look_up_tables.stem_texture', 'specimens.look_up_tables.synonym', 'specimens.look_up_tables.taste', 'specimens.look_up_tables.toxic', 'specimens.look_up_tables.universal_outer_veil_appearance',
        'specimens.look_up_tables.universal_outer_veil_fate', 'specimens.look_up_tables.universal_outer_veil_texture', 'specimens.look_up_tables.veil', 'specimens.partials.add-to-cluster-modal', 'specimens.partials.add-to-group-modal',
        'specimens.partials.button-view-clusters-modal', 'specimens.partials.button-view-groups-modal', 'specimens.show', 'terms', 'trees.create',
        'trees.edit', 'trees.index', 'trees.show', 'vendor.livewire.bootstrap', 'vendor.livewire.simple-bootstrap',
        'vendor.livewire.simple-tailwind', 'vendor.livewire.tailwind', 'welcomeDELETE', 'laravel-exceptions-renderer::components.card', 'laravel-exceptions-renderer::components.context',
    ...
    registerArgumentsSet('env',
        ...
        'APP_URL', 'APP_LOCALE', 'APP_FALLBACK_LOCALE', 'APP_FAKER_LOCALE', 'APP_MAINTENANCE_STORE',
        ...
        'DB_USERNAME', 'DB_PASSWORD', 'MBLIST_DB_CONNECTION', 'MBLIST_DB_HOST', 'MBLIST_DB_PORT',
        'MBLIST_DB_DATABASE', 'MBLIST_DB_USERNAME', 'MBLIST_DB_PASSWORD', 'SESSION_DRIVER', 'SESSION_LIFETIME',
        ...
        'AWS_USE_PATH_STYLE_ENDPOINT', 'TELESCOPE_ENABLED', 'VITE_APP_NAME', );
